  ...
  <div class="page-stack">
    ...
    <section class="welcome-band">
      ...
      <div class="welcome-band__status">
        <ShieldCheck :size="20" /><span>Periode {{ selectedYear }}</span
    ...
    <section v-if="!yearHasData" class="panel year-empty-state">
      <CalendarX2 :size="36" />
      <strong>Belum ada data untuk {{ selectedYear }}</strong>
      <p>Pilih tahun lain untuk melihat ringkasan keuangan koperasi.</p>
    </section>
    ...
    <template v-else>
      <section class="metric-grid">
        ...
        <article class="metric-card">
          ...
          <p>Total simpanan</p>
          <strong>{{ formatCurrency(yearTotals.savings, true) }}</strong
        ...
        <article class="metric-card">
          ...
          <p>Anggota aktif</p>
          <strong>{{ yearTotals.members }}</strong
      ...
      <section class="dashboard-grid">
        <article class="panel panel--chart">
          ...
          <div class="chart-summary">
            ...
            <div>
              <Scale :size="18" /><span>Kas net</span
              ><strong>+Rp92,0 jt</strong>
            </div>
          </div>
        </article>
      ...
      <section class="dashboard-grid dashboard-grid--bottom">
        <article class="panel activity-panel">
          ...
          <div class="activity-list">
            <div
              v-for="transaction in yearTransactions.slice(0, 4)"
              :key="transaction.id"
              class="activity-row"
            >
              <span
