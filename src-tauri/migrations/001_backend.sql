...
CREATE TABLE IF NOT EXISTS savings_accounts (
  ...
  account_type TEXT NOT NULL CHECK (account_type IN ('POKOK', 'WAJIB', 'MANASUKA')),
...
CREATE TABLE IF NOT EXISTS loans (
  ...
  interest_type TEXT NOT NULL CHECK (interest_type IN ('Menurun', 'Flat')),
  realization_date TEXT NOT NULL,
  due_date TEXT NOT NULL,
  status TEXT NOT NULL CHECK (status IN ('Draf', 'Berjalan', 'Perlu review', 'Lunas')),
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS transactions (
  ...
  status TEXT NOT NULL CHECK (status IN ('Terposting', 'Draf', 'Dibalik')),
